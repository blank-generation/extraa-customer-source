...
function Feedback() {
  ...
  const resendOTP = () => {
    ...
    otpData.append("phone_number", phNum);
    axios
  ...
  useEffect(() => {
    ...
    axios.post(pathURL + "/get-questions", formData).then(
      (response) => {
  ...
  function SendOTP() {
    ...
    axios.post(pathURL + "/send-login-otp", OtpFormData).then((response) => {
      console.log(response);
    });
  }
          ...
          if (res.MESSAGE.success === "true") {
            ...
            if (res.MESSAGE.parameters.access_token) {
              localStorage.setItem(
                "token",
                res.MESSAGE.parameters.access_token
              );
            }
            ...
            if (res.MESSAGE.parameters.gender) {
              localStorage.setItem(
                "user_name",
                res.MESSAGE.parameters.user_name
              );
            ...
            <Fade in>
              <div>
                ...
                <MCQ4
                  ...
                  questionType={questions[pageIndex - 1].type}
                  SetAnswer={SetAnswer}
                ></MCQ4>
              </div>
            </Fade>
            ...
            <Fade in>
              ...
              <div className="user-login">
                <Stack alignItems={"center"} pt={12}>
                  ...
                  <ValidatorForm onSubmit={() => handlePhSubmit(phNum)}>
                    <TextValidator
